...
반려동물과 함께 떠나는 여행지 찾기 — 전국 3,400여 곳의 반려동물 동반 가능 여행지를 검색하고, 동반 조건·주변 편의시설·T맵 길찾기까지 한 번에.
...
`mungtrip.db` (SQLite) — 두 소스 병합 12,062곳 수집, 쇼핑(브랜드 매장 8,657곳)은 기본 제외해 **3,405곳 노출**:
...
- 주변 편의시설 (상세페이지, 직선거리·지도 마커):
  ...
  - 🏥 동물병원 — 문화정보원 CSV 반려의료 중 동물병원 12,673곳, 5km 내 3곳, 전화 탭하면 바로 연결 (빨간 마커)
